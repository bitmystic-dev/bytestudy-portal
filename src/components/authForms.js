  ...
  container.innerHTML = `
    <div class="bs-container" style="max-width: 420px; margin-top: 40px;">
      <div class="bs-card">
        ...
        <p style="font-size: 14px; color: #64748b; margin-bottom: 20px; text-align: center;">Enter your credentials to access your materials</p>
        
        <div id="auth-alert"></div>

        <form id="form-login">
          <label style="font-size: 13px; font-weight: 600; color: #334155;">Email Address</label>
        ...
        <button type="button" id="btn-goto-forgot" style="background:none; color:#4f46e5; width:100%; margin-top:12px; font-size:14px;">Forgot Password?</button>
        <button type="button" id="btn-goto-signup" style="background:none; color:#64748b; width:100%; margin-top:8px; font-size:14px;">Need an account? Sign up</button>
      </div>
    </div>
  `;
  ...
  container.innerHTML = `
    <div class="bs-container" style="max-width: 420px; margin-top: 40px;">
      <div class="bs-card">
        ...
        <p style="font-size: 14px; color: #64748b; margin-bottom: 20px; text-align: center;">Register to access enrolled ByteStudy modules</p>
        
        <div id="auth-alert"></div>

        <form id="form-signup">
          <label style="font-size: 13px; font-weight: 600; color: #334155;">Full Name</label>
          ...
          <label style="font-size: 13px; font-weight: 600; color: #334155;">Password (min. 6 characters)</label>
        ...
        <button type="button" id="btn-goto-login" style="background:none; color:#64748b; width:100%; margin-top:12px; font-size:14px;">Already registered? Sign In</button>
      </div>
    </div>
  `;
  ...
  container.innerHTML = `
    <div class="bs-container" style="max-width: 420px; margin-top: 40px;">
      <div class="bs-card">
        ...
        <p style="font-size: 14px; color: #64748b; margin-bottom: 20px; text-align: center;">Receive a reset link via email</p>
        ...
        <button type="button" id="btn-goto-login" style="background:none; color:#64748b; width:100%; margin-top:12px; font-size:14px;">Back to Sign In</button>
      </div>
    </div>
  `;
